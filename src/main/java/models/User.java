...
public class User implements Serializable
{
     ...
     * It should be generated by {@link etc.HelperUtils#getRndSecureString(int)}
     * 
     ...
     * This should be generated by {@link etc.HelperUtils#getRndSecureString(int)}
     * @param confirmation
     */
     ...
     * @param pw the Password the User entered
