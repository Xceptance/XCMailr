...
XCMAILR_OPTS="-Dxcmailr.xcmstarter.home=$CURR_DIR -Dxcmailr.xcmstarter.host=localhost -Dninja.external.configuration=conf/application.conf -Dninja.mode=prod $@"
