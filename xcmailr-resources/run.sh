...
XCMAILR_OPTS="-Dxcmailr.xcmstarter.home=$CURR_DIR -Dxcmailr.xcmstarter.host=localhost -Dxcmailr.xcmstarter.port=8080 -Dninja.external.configuration=conf/application.conf -Dninja.mode=prod -Dxcmailr.xcmstarter.firstrun=true"
